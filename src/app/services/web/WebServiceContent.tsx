...
const service = TECHNICAL_SERVICES[0];
    ...
    <div className="pt-28">
      ...
      <SectionWrapper withDivider>
        <SectionHeading
          ...
          title="What We"
          titleAccent="Deliver"
          subtitle="Every web application we build is engineered for performance, scalability, and exceptional user experience."
        />
        <AnimateInView
      ...
      {service.technologies && (
        <SectionWrapper withDivider>
          <SectionHeading
            ...
            title="Technologies"
            titleAccent="We Use"
            subtitle="Modern, battle-tested technologies trusted by the world's best engineering teams."
          />
          <AnimateInView
            variants={staggerContainer}
      ...
      {service.useCases && (
        <SectionWrapper withDivider>
          <SectionHeading
            ...
            subtitle="From SaaS startups to enterprise portals — we've delivered web applications across diverse industries."
          />
          <AnimateInView
            variants={staggerContainer}
            ...
            {service.useCases.map((useCase) => (
              ...
              >
                ...
                <p className="mt-1 text-sm text-zinc-500">
                  Custom-tailored solutions designed for {useCase.toLowerCase()} with modern architecture and best practices.
                </p>
              </motion.div>
            ))}
          </AnimateInView>
